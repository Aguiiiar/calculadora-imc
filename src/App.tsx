...
import { CalculeteImc, Level, levels } from './helpers/imc';
...
export default function App() {
  ...
  function handleCalculteButton() {
    if (heightField && weightField) {
      setToShow(CalculeteImc(heightField, weightField));
    } else {
        ...
        <div className={styles.container}>
          <div className={styles.leftSize}>
            ...
            <p>IMC é a sigla para Índice de Massa Corpórea, parâmetro adotado pela Organização
              Mundial de Saúde para calcular o peso ideal de cada pessoa.</p>
